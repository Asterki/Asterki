  ...
  return (
    <div className={styles['page']}>
      <Head>
        ...
        <meta name="description" content={props.lang.description} />
      ...
      <main>
        <section className={`${styles['main']} page`} hidden id="main-page">
          <img
          ...
          >
            {props.lang.mainPage.blog}
          </Button>
        </section>

        <section className={`${styles['main']} page`} hidden id="about-page">
          <h1>{props.lang.title}</h1>
          <h3>{props.lang.description}</h3>

          <h3>{props.lang.aboutPage.tools}</h3>
          <p>
        ...
        <section className={`${styles['main']} page`} hidden id="contact-page">
          <h1>{props.lang.title}</h1>
          <h3>{props.lang.contactPage.title}</h3>

          <ul>
            <li>{props.lang.contactPage.email}</li>
            <li>{props.lang.contactPage.discord}</li>
            <li>{props.lang.contactPage.twitter}</li>
            <li>{props.lang.contactPage.instagram}</li>
          </ul>
        ...
        <section className={`${styles['main']} page`} hidden id="blog-page">
          <h1>{props.lang.title}</h1>
          <h3>{props.lang.blogPage.soon}</h3>
...
Home.getInitialProps = async (context: any) => {
  var headerLanguage = new locale.Locales(context.req.headers['accept-language'] || "en");
  const supported = new locale.Locales(['en', 'es', 'de', 'fr', 'pt', 'it']);

  const languageCode = headerLanguage.best(supported).code;
  const lang = require(`../locales/${languageCode}.ts`);
