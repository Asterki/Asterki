    ...
    return (
        ...
        >
            ...
            <main>
                ...
                <div className="skills-cards">
                    <div className="skill-card">
                        <img src="https://vitejs.dev/logo-with-shadow.png" alt="vite.js" width="40" height="40" />
                ...
                <div className="skills-cards">
                    <div className="skill-card">
                        <img src="https://fontawesome.com/images/favicon/icon.svg" alt="fontawesome" width="40" height="40" />
                        <p>FontAwesome</p>
                    </div>
                ...
                <div className="skills-cards">
                    ...
                    <div className="skill-card">
                        <img src="https://www.framer.com/images/favicons/iOS/180.png" alt="Framer Motion" width="40" height="40" />
