    ...
    return (
        ...
        >
            ...
            <main className="mt-24 flex items-center justify-center flex-col w-full">
                ...
                <div className="md:w-7/12 w-11/12 flex items-center flex-wrap justify-center flex-1">
                    <div className="bg-white/10 hover:bg-white/20 transition-all rounded-md flex items-center m-2 px-4 py-2 w-4/12 md:w-2/12">
                        <img className="mr-2"
